...
import Link from "next/link"; // Adjust the path to your logo image
      ...
      <div className="flex flex-1 items-center justify-center bg-gradient-to-r from-green-400 to-green-700 p-6">
        <div className="bg-white bg-opacity-30 p-20 rounded-lg shadow-inner backdrop-blur-md animate-fade-in">
          ...
          <form>
            ...
            {/* Roll No */}
            <div className="mb-4 relative">
              <label className="block text-sm font-medium text-gray-700" htmlFor="rollno">
                Roll No
              </label>
              <input
                type="text"
            ...
            <div className="mt-4 text-center">
              <Link href="/Login" className="text-black text-xl p-4 opacity-100 hover:opacity-75 transition-opacity duration-200 font-bold">
